  ...
  public async execute(state: GameState, params: AdminCommandParams): Promise<AdminCommandResult> {
    ...
    switch (command) {
      ...
      case "/add-item": {
        ...
        const updated = this.worldService.addItemToCharacter(state, charName, item);
        return {
          state: updated,
      ...
      case "/remove-item": {
        ...
        const updated = this.worldService.removeItemFromCharacter(state, charName, item);
        return {
          state: updated,
      ...
      case "/add-char": {
        ...
        const updated = this.worldService.addCharacter(state, {
          name: name.trim(),
      ...
      case "/remove-char": {
        ...
        const updated = this.worldService.setCharacterStatus(state, charName.trim(), "lost");
        return {
          state: updated,
      ...
      case "/add-location": {
        ...
        const updated = this.worldService.addLocation(state, {
          id: id.trim(),
          name: name.trim(),
          description: description.trim(),
          connectedTo
      ...
      case "/remove-location": {
        ...
        const updated = this.worldService.removeLocation(state, locationId.trim());
        return {
          state: updated,
      ...
      case "/add-concept": {
        ...
        const updated = this.worldService.addConcept(state, {
          id: id.trim(),
          type: type as any,
          name: name.trim(),
          description: description.trim()
      ...
      case "/remove-concept": {
        ...
        const updated = this.worldService.removeConcept(state, conceptId.trim());
        return {
          state: updated,
      ...
      case "/extract": {
        ...
        const updated = await this.worldService.applyAutomaticStateUpdates(state, lastNarrative);
        return {
          state: updated,
