...
describe("WorldService.applyStepUpdates", () => {
  ...
  it("aplica grab com grounding + dedup, descarta sem citação e nome inválido", () => {
    const service = new WorldService(mockLlmService);
...
describe("WorldService.advanceVitality", () => {
  const mockLlmService = {} as unknown as LlmService;
...
describe("WorldService.applySceneUpdates", () => {
  const mockLlmService = {} as unknown as LlmService;
