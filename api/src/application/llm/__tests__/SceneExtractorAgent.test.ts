...
import { SceneExtractorAgent } from '../extractors/scene/SceneExtractorAgent.js';
...
describe('SceneExtractorAgent', () => {
  it('retorna o delta normalizado (sem exigir `id`)', async () => {
    ...
    const agent = new SceneExtractorAgent(client as any, resolver as any);
