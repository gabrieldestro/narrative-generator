...
import { validateInventoryDelta, normalizeInventoryDelta } from "../../shared/selfHealing/JsonValidators.js";
import { ExtractorBase } from "./ExtractorBase.js";
import {
  INVENTORY_FORMAT_SPEC,
  INVENTORY_SYSTEM_PROMPT,
  inventoryHumanPrompt,
} from "../../../domain/prompts/extractors/inventory.js";

/**
 * Extrator de inventário (doc 27, Fase 2 — §6.2/§7.2).
 * Só roda o LLM com sinal (`hasSignal`); grounding estrito + allowlist de
 * nomes vivem na fusão (`WorldService.applyStepUpdates`).
 */
export class InventoryService extends ExtractorBase<InventoryDelta> {
