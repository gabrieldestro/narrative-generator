...
import { validateConditionsDelta, normalizeConditionsDelta } from "../../shared/selfHealing/JsonValidators.js";
import { ExtractorBase } from "./ExtractorBase.js";
import {
  CONDITIONS_FORMAT_SPEC,
  CONDITIONS_SYSTEM_PROMPT,
  conditionsHumanPrompt,
} from "../../../domain/prompts/extractors/conditions.js";
 ...
 */
export class ConditionsService extends ExtractorBase<ConditionsDelta> {
