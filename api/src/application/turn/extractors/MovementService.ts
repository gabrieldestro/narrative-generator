...
import { validateMovementDelta, normalizeMovementDelta } from "../../shared/selfHealing/JsonValidators.js";
...
import {
  ...
  movementHumanPrompt,
} from "../../../domain/prompts/extractors/movement.js";
 ...
 */
export class MovementService extends ExtractorBase<MovementDelta> {
